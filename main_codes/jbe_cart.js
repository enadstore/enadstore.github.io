...
function del_cartItem(usercode,stockno){
  MSG_SHOW(vbYesNo,"CONFIRM: ","Remove this Item from your Cart?",function(){          
    ...
    showProgress(true);    
    axios.post('../../main_codes/api/z_cart.php', { clientno:CURR_CLIENT, request: 41,    
      usercode: usercode,
      stockno: stockno    
    },JBE_HEADER)
...
function add_cart(){
  ...
  showProgress(true);    
  axios.post('../../main_codes/api/z_cart.php', { clientno:CURR_CLIENT, request: 2,    
    stockno: stockno,
    usercode: CURR_USER
  },JBE_HEADER)
  .then(function (response) {     
...
function save_order(){ 
  ...
  axios.post('../../main_codes/api/z_order.php', { clientno:CURR_CLIENT, request: 2,
    trano:trano,
    usercode:CURR_USER,
    trandate:vDate,
    trantime:vTime,
