...
function saveCharges(trano,i){
	...
	showProgress(true);  
    axios.post('../../main_codes/api/z_order.php', { clientno:CURR_CLIENT, request: 32,    
      charge:v_charge,    
      total:tot,    
      trano:trano
    },JBE_HEADER)
...
function delCancel(t,u){
  MSG_SHOW(vbYesNo,"CANCELLED ORDER: ","Are you sure to Delete this record?",function(){
    showProgress(true);  
    axios.post('../../main_codes/api/z_order.php', { clientno:CURR_CLIENT, request: 41,    
      trano:t,    
      usercode:u
    },JBE_HEADER)
    .then(function (response) {     
...
function chgItemStat(u,t,s){
  ...
  showProgress(true);      
  axios.post('../../main_codes/api/z_order.php', { clientno:CURR_CLIENT, request: 331, 
    usercode: u,
    trano: t,
    stat: s
  },JBE_HEADER)
