function start_app(){
  ...
  //****************  
  //alert('start_app');
  axios.post('../../main_codes/api/z_online.php',JBE_HEADER)     
...
function get_db_user(u,f_showprofile){
  ...
  //alert(f_showprofile);
  DB_USER=[];
  axios.post('../../main_codes/api/z_user.php', { clientno:CURR_CLIENT,request: 1, usercode: u })
  .then(function (response) {    
...
function get_db_clients(){
  //alert(f_showprofile);
  DB_CLIENTS=[];    
  axios.post('../../main_codes/api/z_user.php', { clientno:CURR_CLIENT,request: 0 })     
  .then(function (response) { 
...
function get_db_cat(){
  DB_CAT=[];
  axios.post('../../main_codes/api/z_cat.php', { clientno:CURR_CLIENT, request: 0 }) 
  .then(function (response) { 
...
function get_db_stock(){
  DB_STOCK=[];
  axios.post('../../main_codes/api/z_stock.php', { clientno:CURR_CLIENT,request: 0 }) 
  .then(function (response) { 
      console.log(response.data); 
...
function get_db_cart(u){        
  ...
  axios.post('../../main_codes/api/z_cart.php', { clientno:CURR_CLIENT,request:req, usercode:u }) 
  .then(function (response) { console.log(response.data); DB_CART = response.data; refreshNOTIF('cart'); })    
  .catch(function (error) { console.log(error); }); 
}
function get_db_comments(){
  DB_COMMENT=[];
  axios.post('../../main_codes/api/z_comment.php', { clientno:CURR_CLIENT,request: 0 }) 
...
function get_db_sys(){  
  ...
  DB_SYS=[]; DB_SLIDER=[];
  axios.post('../../main_codes/api/z_sysfile.php', { clientno:CURR_CLIENT,site:CURR_SITE,request: 1 }) 
  .then(function (response) { 
      console.log(DB_SYS);     
...
function get_db_order(u){
  ...
  axios.post('../../main_codes/api/z_order.php', { clientno:CURR_CLIENT,request: req, usercode: u })     
  .then(function (response) { 
    console.log(response.data); 
...
function get_db_bell(u){
  ...
  axios.post('../../main_codes/api/z_bell.php', { clientno:CURR_CLIENT,request: req, usercode: u })     
...
function get_db_chat(u){
  ...
  axios.post('../../main_codes/api/z_chat.php', { clientno:CURR_CLIENT,request: req, usercode: u })     
...
function showMainPage(){ 
  ...
  axios.post('../../main_codes/api/z_notif.php',{ clientno:CURR_CLIENT, request: 0, usercode: v_curr_user })     
